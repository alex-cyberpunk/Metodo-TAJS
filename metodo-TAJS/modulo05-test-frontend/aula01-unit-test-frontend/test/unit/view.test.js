...
describe('View test suite', () => {
    it('#updateList should append content to card-list innerHTML',()=>{
        ...
        const view = new View()
        const data = [
            {title: 'teste', ImageUrl: 'https://teste.com.br'}
        ]
        ...
        expect(innerHTMLSpy).toHaveBeenCalledWith(1,baseHTML + generatedContent)
        
        view.updateList([data])
        expect(innerHTMLSpy).toHaveBeenCalledWith(2,baseHTML + generatedContent)
